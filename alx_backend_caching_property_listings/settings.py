...
SECRET_KEY = 'django-insecure-@)b71znb=9+kqt+2x+8%uqh2y#dkin39m0^&!m_2i=m3cz*12q'
...
DATABASES = {
    'default': {
        ...
        'HOST': 'postgres',  # Same as service name in docker-compose
        'PORT': '5432',
    }
}
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://redis:6379/0',  # redis is from docker-compose service name
        'OPTIONS': {
